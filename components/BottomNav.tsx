          ...
          return (
            <button
              ...
              className={`flex flex-col items-center gap-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg transition-all duration-200 min-h-[60px] sm:min-h-[64px] touch-manipulation focus:outline-none focus:ring-2 focus:ring-accent focus:ring-opacity-50 ${
                isActive 
                  ? 'text-indigo-400 bg-indigo-500 bg-opacity-20 scale-105' 
                  : 'text-gray-400 hover:text-white hover:bg-gray-700 hover:bg-opacity-30 active:scale-95'
              }`}
            ...
            >
              ...
              {isActive && (
                <div className="w-1 h-1 bg-indigo-400 rounded-full mt-1 animate-pulse" />
              )}
            </button>
          );
        })}
